...
namespace Design.Constant
{
    public class Constants
    {
        ...
        // Font path
        public const string FONT_PATH_BOLD = "Fonts/MontserratAlternates-Bold.otf";
        public const string FONT_PATH_MEDIUM = "Fonts/MontserratAlternates-Medium.otf";
        public const string FONT_PATH_REGULAR = "Fonts/MontserratAlternates-Regularr.otf";
    ...
    public class Color
    {
        public const string DARK_GREEN_HEX_CODE = "#64DD17";
        public const string SHINY_GREEN_HEX_CODE = "#76FF03";
        public const string DARK_GREY_HEX_CODE = "#263238";
        public const string BG_LITE_ASH_HEX_CODE = "#ECEFF1";
    }
}